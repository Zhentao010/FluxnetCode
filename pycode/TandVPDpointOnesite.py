# -*- coding: utf-8 -*-
"""
Created on Thu Nov 24 22:09:30 2022
...
for csv_file in os.listdir(path):
    ...
    #将统计的数据保存
    path00 = 'C:/Users/Lenovo/Desktop/未划分年份的初级数据/单个站点不同温度点VPD点的T及RESP/原统计数据/' + csv_file[4:10] + '.csv';
    result_pd = pd.DataFrame(result);
    result_pd.to_csv(path00, index= False, header= False)
    #将统计好的数据计算平均值
    path11 = 'C:/Users/Lenovo/Desktop/未划分年份的初级数据/单个站点不同温度点VPD点的T及RESP/平均值/' + csv_file[4:10] + '.csv';
