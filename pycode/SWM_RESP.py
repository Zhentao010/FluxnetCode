# -*- coding: utf-8 -*-
"""
Created on Sun Nov 20 18:56:31 2022
...
def SWCREdata(fileN):
    ...
    for i1 in range(ecom):
       if eco['RECO_NT_VUT_REF'][i1] !=-9999 and eco['SWC_F_MDS_1'][i1] !=-9999 and eco['RECO_NT_VUT_REF'][i1] !=0 and eco['SWC_F_MDS_1'][i1] !=0:
           data[n1][0] = eco['TIMESTAMP_START'][i1];
           data[n1][1] = eco['SWC_F_MDS_1'][i1];
...
path0 = 'C:/Users/Lenovo/Desktop/未划分年份的初级数据/Night方法/土壤水分和RE/';  #储存计算得到的VPD月平均值文件的位置
...
path11 = 'C:/Users/Lenovo/Desktop/SWM_RESP_Slope.xlsx'
