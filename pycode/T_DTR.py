# -*- coding: utf-8 -*-
"""
Created on Fri Nov 25 10:07:37 2022
...
path1 = 'C:/Users/Lenovo/Desktop/未划分年份的初级数据/原始数据T_DTR/';    #储存读取的DTR_VPD_SWC数据的位置
path2 = 'C:/Users/Lenovo/Desktop/T_DTR_Slope.xlsx'    #储存计算的相关系数的位置
slope = np.zeros((1,1));
